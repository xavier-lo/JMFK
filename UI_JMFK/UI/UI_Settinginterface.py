...
class Ui_DialogSettinginterface(object):
    def setupUi(self, DialogSettinginterface):
        ...
        self.label.setGeometry(QtCore.QRect(40, 90, 81, 18))
        ...
        self.label_2.setGeometry(QtCore.QRect(40, 140, 101, 18))
        ...
        self.label_3.setGeometry(QtCore.QRect(40, 200, 81, 18))
    ...
    def retranslateUi(self, DialogSettinginterface):
        ...
        self.groupBox.setTitle(_translate("DialogSettinginterface", "Setting"))
        self.label.setText(_translate("DialogSettinginterface", "COM Port:"))
        self.label_2.setText(_translate("DialogSettinginterface", "IC Sector:"))
        self.label_3.setText(_translate("DialogSettinginterface", "Password:"))
        self.pushButton.setText(_translate("DialogSettinginterface", "SAVE"))
